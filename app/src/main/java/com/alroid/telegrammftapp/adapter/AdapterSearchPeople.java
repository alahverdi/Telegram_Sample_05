...
public class AdapterSearchPeople extends RecyclerView.Adapter<AdapterSearchPeople.LikesViewHolder> {
    Context context;
    List<Search> searchList;
    SelectedSearch selectedSearch;

    public AdapterSearchPeople(Context context, List<Search> searchList, SelectedSearch selectedSearch) {
        ...
        public LikesViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selectedSearch.selectedSearch(searchList.get(getAdapterPosition()));
                }
            });
